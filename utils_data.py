...
def get_data():
    df = pd.read_csv('https://raw.githubusercontent.com/misrori/flights2/main/csv_data/last_prices.csv')
    #df = pd.read_csv('last_prices.csv')

    
    # Load data (replace with actual data sources)
    airports = pd.read_csv('https://raw.githubusercontent.com/misrori/flights2/main/csv_data/airportrs.csv')
